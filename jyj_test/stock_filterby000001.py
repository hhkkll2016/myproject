...
benchmarkday = datetime.date.today()- datetime.timedelta(days=0)
before61days = benchmarkday - datetime.timedelta(days=90)
...
for i in prestocklist:
    ...
    totalbar['g'+i] = stockbar['diff'] - totalbar['benchmark'] + totalbar['offset']
    print(m,i)
    m = m+1
